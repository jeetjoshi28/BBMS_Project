...
<input type="password"  value= "<?php  if(isset($_POST["show"])){ echo $pass ;}  ?>"  required="required" pattern="[a-zA-Z0-9]{3,10}" title="please enter only character and numbers between 3 to 10 for password" name="t2"  /></td></tr>
<tr><td class="lefttd">Confirm Password</td><td>
<input type="password"  value= "<?php  if(isset($_POST["show"])){ echo $pass ;}?>" name="t3" required="required" pattern="[a-zA-Z0-9]{3,10}" title="please enter only character and numbers between 3 to 10 for password"/></td></tr>
<tr><td class="lefttd">Type Of User</td><td>
<select name="s1" required  ><option value="">Select</option>
