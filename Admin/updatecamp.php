...
<tr><td class="lefttd">Camp Title</td><td>
...
?>
"/ required="required" pattern="[a-zA-Z0-9]{5,40}" title="please enter only character or numbers between 5 to 40 for camp title">
</td></tr>
<tr><td class="lefttd">Organized By</td><td>
...
?>
" required="required" pattern="[a-zA-Z0-9]{5,45}" title="please enter only character or numbers between 5 to 45 for organizer name"/>
</td></tr>
<tr><td class="lefttd">State 
</td><td><select name="s1" required><option value="">Select</option>
<?php
	$cn=makeconnection();
	$s="select * from state";
	$result=mysqli_query($cn,$s);
