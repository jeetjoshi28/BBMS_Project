...
<div style="height:300px; width:600px; margin:auto; margin-top:50px; margin-bottom:173px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
<form method="post">
